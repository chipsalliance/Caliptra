...
* **Checklist Item:**
  ...
  * **Evaluation Methodology:** Manufacturers MUST identify the Caliptra RTL release consumed by the product and provide evidence that the selected ROM/FMC/Runtime versions are compatible according to the published versioning compatibility matrix.
* **Checklist Item:**
