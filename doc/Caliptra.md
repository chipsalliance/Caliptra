...
14. Irrespective of success or failure from image authentication (step 15 or 16), Caliptra ROM clears the image activation bit before updating `RECOVERY_STATUS` & `DEVICE_STATUS` registers.
