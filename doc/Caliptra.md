...
* Caliptra’s state is considered a mode of operation.
  * Caliptra security state is a packed struct consisting of two fields
    * debug_locked: A 4-bit encoding where 4'd6=TRUE and 4'd9=FALSE. A value of TRUE indicates debug is locked, while FALSE indicates that debug is unlocked.
    * device_lifecycle: A 2-bit enumeration where 2'b00=unprovisioned, 2'b01=manufacturing, and 2'b11=production.
