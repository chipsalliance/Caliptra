...
6. The laboratory produces an evaluation technical report, using an evaluation technical report template and sends it to the Caliptra Trademark Owner at <caliptra-tm@lists.chipsalliance.org>.
